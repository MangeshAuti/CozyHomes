		        ...
		        <div class="panel panel-primary prop_quick_view">
		           ...
		           <div class="panel-body">
	                 ...
	                 <c:if test="${prop.accomType eq 'Shared'}">
	                   <span title="No of beds"  class="prop_info${prop.propId} prop_info" id="noBeds"> <i class="fa fa-bed fa-prop" aria-hidden="true"></i><span class="edit_prop" contenteditable> ${prop.noBeds}</span></span>
	                 </c:if>
	                 <c:if test="${prop.accomType eq 'Private'}">
	                   <span title="No of Rooms" class="prop_info${prop.propId} prop_info" id="noRooms"> <i class="fa fa-user-plus fa-prop" aria-hidden="true"></i><span class="edit_prop" contenteditable> ${prop.noRooms}</span></span>
	                 </c:if>
