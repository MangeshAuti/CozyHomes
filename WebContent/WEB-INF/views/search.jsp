...
<hr>
	...
	<c:forEach var="prop" items="${sessionScope.propList}">
  	<div class="row">
		...
		<div class="col-md-4">
			<div class="img_div" style="height:243px !important">
		    	...
		    	<div class="panel-body">
		              ...
		              <span  class="prop_info">
		                 ...
		                 <c:if test="${prop.accomType eq 'Private'}">
		                   <span title="No of Rooms" class="prop_info${prop.propId}" id="noRooms"> <i class="fa fa-user-plus fa-prop" aria-hidden="true"></i> ${prop.noRooms}</span>
		                 </c:if>
		              </span>
